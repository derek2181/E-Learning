    ...
    $(document).ready(function() {
        ...
        $('#addLevelButton').click(() => {
            var template =
                ...
                "                          <\/div>" +
                `                             <input type=\"checkbox\" class=\"btn-check checkbox-isfree\" id="btncheck${level}" autocomplete=\"off\" name=\"level-free[]\">` +
                `                              <label class=\"btn btn-outline-success free-checkbox\" for="btncheck${level}">Marcar como nivel gratis</label>` +
                "                        <\/div>" +
